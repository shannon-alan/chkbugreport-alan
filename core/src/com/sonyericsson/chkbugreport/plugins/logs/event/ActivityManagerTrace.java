...
public class ActivityManagerTrace {
    ...
    private void addAMDataUnsafe(String eventType, BugReportModule br, LogLine sl, int i) {
        ...
        if ("am_create_activity".equals(eventType)) {
        	//Tinno:CJ 30005 am_create_activity (User|1|5),(Token|1|5),(Task ID|1|5),(Component Name|3),(Action|3),(MIME Type|3),(URI|3),(Flags|1|5)
        	if(br.getAndroidVersionSdk() >= 19)
        		addAMData(new AMData(AMData.ACTIVITY, AMData.ON_CREATE, -1, sl.getFields(3), sl.ts));
        	else
        	...
        	//Tinno:CJ 30018 am_destroy_activity (User|1|5),(Token|1|5),(Task ID|1|5),(Component Name|3),(Reason|3)
        	if(br.getAndroidVersionSdk() >= 19)
        		addAMData(new AMData(AMData.ACTIVITY, AMData.ON_DESTROY, -1, sl.getFields(3), sl.ts));
        	else
        	...
        	//Tinno:CJ 30013 am_pause_activity (User|1|5),(Token|1|5),(Component Name|3)
        	if(br.getAndroidVersionSdk() >= 19)
        		addAMData(new AMData(AMData.ACTIVITY, AMData.ON_PAUSE, -1, sl.getFields(2), sl.ts));
        	else
        		addAMData(new AMData(AMData.ACTIVITY, AMData.ON_PAUSE, -1, sl.getFields(d+1), sl.ts));
        } else if ("am_resume_activity".equals(eventType)) {
        	//Tinno:CJ 30018 am_destroy_activity (User|1|5),(Token|1|5),(Task ID|1|5),(Component Name|3),(Reason|3)
        	if(br.getAndroidVersionSdk() >= 19)
        		addAMData(new AMData(AMData.ACTIVITY, AMData.ON_RESUME, -1, sl.getFields(3), sl.ts));
        	else
        	...
        	//Tinno:CJ for 4.4 mtk : 30030 am_create_service (User|1|5),(Service Record|1|5),(Name|3),(UID|1|5),(PID|1|5)
        	if(br.getAndroidVersionSdk() >= 19)
        	{
        		int pid = Integer.parseInt(sl.fields[4]); // NOTE: due to other changes, the delta is not needed here
            	addAMData(new AMData(AMData.SERVICE, AMData.ON_CREATE, pid, sl.getFields(1), sl.ts));
            	suggestName(br, sl, 4, 1, 18); // NOTE: due to other changes, the delta is not needed here
        	}
        	else
        	{
        	...
        	//Tinno:CJ for 4.4 mtk : 30031 am_destroy_service (User|1|5),(Service Record|1|5),(PID|1|5)
        	if(br.getAndroidVersionSdk() >= 19)
        	{
        	...
        	//Tinno:CJ 30011 am_proc_died (User|1|5),(PID|1|5),(Process Name|3)
        	if(br.getAndroidVersionSdk() >= 19)
        	{
	            int pid = Integer.parseInt(sl.fields[1]);
	            addAMData(new AMData(AMData.PROC, AMData.PROC_DIED, pid, sl.getFields(2), sl.ts));	            
	            suggestName(br, sl, 1, 2, 20);
        	}
        	else
        	{
	            int pid = Integer.parseInt(sl.fields[d+0]);
        	...
        	//Tinno:CJ 30014 am_proc_start (User|1|5),(PID|1|5),(UID|1|5),(Process Name|3),(Type|3),(Component|3)
        	if(br.getAndroidVersionSdk() >= 19)
        	{
        		int pid = Integer.parseInt(sl.fields[1]);
        		addAMData(new AMData(AMData.PROC, AMData.PROC_START, pid, sl.getFields(3), sl.ts));        		
        		suggestName(br, sl, 1, 3, 20);        		
        	}
        	else
        	{
        		int pid = Integer.parseInt(sl.fields[d+0]);
